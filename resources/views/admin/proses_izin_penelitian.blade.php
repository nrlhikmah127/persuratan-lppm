...
@section('content')
    ...
    <div class="container c">
        <a href="{{ url('/req_izinpenelitian') }}" class="text"><img src="/img/back.png" alt="icon back" class="img">BACK</a>
            ...
            <div class="row justify-content-center">
                <div class="col-8" id="printableColumn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <span>: Permohonan Izin Penelitian</span>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-4">
                        <div class="col-12"><span>Sehubungan dengan pelaksanaan kegiatan penelitian berjudul {{ $permohonan->judul }}</span></div>
                        <div class="col-12"><span>Memohon kepada Bapak/Ibu agar sekiranya memberikan izin kegiatan penelitian tersebut. Adapun tim dalam Penelitian ini adalah sebagai berikut:</span></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-12">
