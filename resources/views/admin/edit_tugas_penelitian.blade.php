...
<head>
    ...
    <title>Edit Tugas Penelitian</title>
</head>
...
<body>
    ...
    <div class="container c">
        <a href="{{ url('/proses_tugaspenelitian/'.$tugas->id_srt) }}" class="text"><img src="/img/back.png" alt="icon back" class="img">BACK</a>
    ...
    <div class="container container-edit">
        <form method="POST" action="{{ url('/update_tugaspenelitian/'.$tugas->id_srt) }}">
            @csrf
            <table border="0">
                <tr>
                    <td>
                    ...
                    <td>
                        <input class="form-check-input @error('no_surat') is-invalid @enderror" id="no_surat" name="no_surat"
                            type="text" placeholder="Masukkan Nomor Surat" value="{{ old('no_surat', $tugas->no_surat) }}">
                        @error('no_surat')
                ...
                <tr>
                    <input type="hidden" id="tipe" name="tipe" value="tugas_penelitian">
                    <td>
                        <h3>Judul Penelitian</h3>
                    </td>
                    <td>
                        <input class="form-check-input @error('judul') is-invalid @enderror" id="judul" name="judul"
                            type="text" placeholder="Masukkan Judul Penelitian" value="{{ old('judul', $tugas->judul) }}">
                        @error('judul')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-check-input @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi"
                            type="text" placeholder="Lokasi Penelitian" value="{{ old('lokasi', $tugas->lokasi) }}">
                        @error('lokasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input f @error('ketua') is-invalid @enderror" id="ketua" name="ketua"
                            type="text" placeholder="Nama Lengkap" value="{{ old('ketua', $tugas->ketua) }}">
                        @error('ketua')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
            ...
            <table>
                <tr>
                    <td>
                        <input class="form-check-input r @error('ang1') is-invalid @enderror" id="ang1" name="ang1"
                            type="text" placeholder="Nama Lengkap" value="{{ old('ang1', $tugas->ang1) }}">
                        @error('ang1')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
                    ...
                    <td>
                        <input class="form-check-input o @error('jbtn_ang1') is-invalid @enderror" id="jbtn_ang1"
                            name="jbtn_ang1" type="text"  value="{{ old('jbtn_ang1', $tugas->jbtn_ang1) }}">
                        @error('jbtn_ang1')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang2" name="ang2" type="text" placeholder="Nama Lengkap"  value="{{ old('ang2', $tugas->ang2) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang3" name="ang3" type="text" placeholder="Nama Lengkap"  value="{{ old('ang3', $tugas->ang3) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang4" name="ang4" type="text" placeholder="Nama Lengkap"  value="{{ old('ang4', $tugas->ang4) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang5" name="ang5" type="text" placeholder="Nama Lengkap"  value="{{ old('ang5', $tugas->ang5) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang6" name="ang6" type="text" placeholder="Nama Lengkap"  value="{{ old('ang6', $tugas->ang6) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang7" name="ang7" type="text" placeholder="Nama Lengkap" value="{{ old('ang7', $tugas->ang7) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang8" name="ang8" type="text" placeholder="Nama Lengkap" value="{{ old('ang8', $tugas->ang8) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang9" name="ang9" type="text" placeholder="Nama Lengkap" value="{{ old('ang9', $tugas->ang9) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang10" name="ang10" type="text" placeholder="Nama Lengkap" value="{{ old('ang10', $tugas->ang10) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang11" name="ang11" type="text" placeholder="Nama Lengkap" value="{{ old('ang11', $tugas->ang11) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang12" name="ang12" type="text" placeholder="Nama Lengkap" value="{{ old('ang12', $tugas->ang12) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang13" name="ang13" type="text" placeholder="Nama Lengkap" value="{{ old('ang13', $tugas->ang13) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang14" name="ang14" type="text" placeholder="Nama Lengkap" value="{{ old('ang14', $tugas->ang14) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input r" id="ang15" name="ang15" type="text" placeholder="Nama Lengkap" value="{{ old('ang15', $tugas->ang15) }}">
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input d @error('wkt_mulai') is-invalid @enderror" id="wkt_mulai"
                            name="wkt_mulai" type="date" value="{{ old('wkt_mulai', $tugas->wkt_mulai) }}">
                        @error('wkt_mulai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
                    ...
                    <td>
                        <input class="form-check-input a @error('wkt_sls') is-invalid @enderror" id="wkt_sls" name="wkt_sls"
                            type="date" value="{{ old('wkt_sls', $tugas->wkt_sls) }}">
                        @error('wkt_sls')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
                ...
                <tr>
                    <td>
                        <input class="form-check-input f @error('nama_hub') is-invalid @enderror" id="nama_hub"
                            name="nama_hub" type="text" placeholder="Nama Lengkap" value="{{ old('nama_hub', $tugas->nama_hub) }}">
                        @error('nama_hub')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
                    <td>
                        <input class="form-check-input o @error('no_telp') is-invalid @enderror" id="no_telp"
                            name="no_telp" type="text" placeholder="No. Telp/WA/E-mail" value="{{ old('no_telp', $tugas->no_telp) }}">
                        @error('no_telp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
