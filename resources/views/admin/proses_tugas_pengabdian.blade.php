...
@section('title', 'Proses Request Tugas Pengabdian')
@section('content')
    <!--Jumbotron-->
    <div class="container c">
        <a href="{{ url('/req_tugaspengabdian') }}" class="text"><img src="/img/back.png" alt="icon back" class="img">BACK</a>
        ...
        <div class="row">
            <div class="col-6">
                <a href="/edit_tugaspengabdian/{{ $tugas->id_srt }}" class="btn btn-danger" type="button" style="margin-left: 0px;">
                    EDIT
                </a>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table border="0" align="center">
                                <tr>
                                    <td class="d-flex align-self-center"><img src="/img/logo.png" width="120" height="120" alt="" style="margin-left: 15px;"></td>
                                    <td>
                                        <center>
