...
<head>
    ...
    <title>Edit Tugas Pengabdian</title>
</head>
...
<body>
    ...
    <div class="container c">
        <a href="{{ url('/proses_tugaspengabdian/'.$tugas->id_srt) }}" class="text"><img src="/img/back.png" alt="icon back" class="img">BACK</a>
    ...
    <div class="container container-edit">
        <form method="POST" action="{{ url('/update_tugaspengabdian/'.$tugas->id_srt) }}">
            @csrf
            <table border="0">
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-check-input @error('judul') is-invalid @enderror" id="judul" name="judul"
                            type="text" placeholder="Masukkan Judul Pengabdian" value="{{ old('judul', $tugas->judul) }}">
                        @error('judul')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-check-input @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi"
                            type="text" placeholder="Lokasi Pengabdian" value="{{ old('lokasi', $tugas->lokasi) }}">
                        @error('lokasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
