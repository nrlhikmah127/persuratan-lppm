...
<div class="container c">
    ...
    <!--content-->
    <div class="container">
        <form method="POST" action="{{ url('/tugaspenelitian') }}">
            @csrf
            <table border="0">
                <tr>
                    ...
                    <td>
                        <input class="form-check-input @error('judul') is-invalid @enderror" id="judul" name="judul" type="text" type="text" placeholder="Masukkan Judul Penelitian">
                        @error('judul')
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-check-input @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" type="text" type="text" placeholder="Lokasi Penelitian">
                        @error('lokasi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </td>
            ...
            <table border="0">
                <tr>
                    <td>
                        <input class="form-check-input f @error('ketua') is-invalid @enderror" id="ketua" name="ketua" type="text" placeholder="Nama Lengkap">
                        @error('ketua')
