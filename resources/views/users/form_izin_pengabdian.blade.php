...
@section('title', 'Form Surat Izin Pengabdian')
@section('content')
...
<div class="container">
        <div class="container c">
            ...
            <p>Form Surat Permohonan Izin Pengabdian</p>
            <hr>
        </div>
        <!--Jumbotron-->
        ...
        <!--content-->
        <div class="container">
            <form action="{{ url('/izinpengabdian') }}" method="POST">
                @csrf
                <table border="0">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-check-input @error('kepada') is-invalid @enderror" id="kepada" name="kepada" type="text" placeholder="Cth: Rektor Universitas Lambung Mangkurat">
                            @error('kepada')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </td>
